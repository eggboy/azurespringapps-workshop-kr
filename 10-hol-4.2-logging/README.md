...
![Example output from all application logs query](./images/all-app-logs-in-log-analytics.jpg)
...
![Example output from catalog service logs](./images/catalog-app-logs-in-log-analytics.jpg)
...
![An example output from the Ingress Logs](./images/ingress-logs-in-log-analytics.jpg)
...
![An example out from the Spring Cloud Gateway Logs](./images/spring-cloud-gateway-logs-in-log-analytics.jpg)
...
![An example output from service registry logs](./images/service-registry-logs-in-log-analytics.jpg)

⬅️ Previous guide: [09 - Hands On Lab 4.1 - End-End Observability](../09-hol-4.1-end-to-end-observability/README.md)