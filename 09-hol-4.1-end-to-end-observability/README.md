...
![An image showing the Application Map of Azure Application Insights](./images/fitness-store-application-map.jpg)

Navigate to the `Performance` blade:

![An image showing the Performance Blade of Azure Application Insights](./images/performance.jpg)

Navigate to the `Performance/Dependenices` blade - you can see the performance number for dependencies,
particularly SQL calls:

![An image showing the Dependencies section of the Performance Blade of Azure Application Insights](./images/performance_dependencies.jpg)

Navigate to the `Performance/Roles` blade - you can see the performance metrics for individual instances or roles:

![An image showing the Roles section of the Performance Blade of Azure Application Insights](./images/fitness-store-roles-in-performance-blade.jpg)

Click on a SQL call to see the end-to-end transaction in context:

![An image showing the end-to-end transaction of a SQL call](./images/fitness-store-end-to-end-transaction-details.jpg)

Navigate to the `Failures` blade and the `Exceptions` panel - you can see a collection of exceptions:

![An image showing application failures graphed](./images/fitness-store-exceptions.jpg)
...
![An image showing metrics over time](./images/metrics.jpg)
...
![An image showing custom metrics instrumented by Micrometer](./images/fitness-store-custom-metrics-with-payments-2.jpg)

Navigate to the `Live Metrics` blade - you can see live metrics on screen with low latencies < 1 second:

![An image showing the live metrics of all applications](./images/live-metrics.jpg)

⬅️ Previous guide: [08 - Hands On Lab 3.5 - Configure Azure Key Vault](../13-hol-3.5-configure-azure-keyvault/README.md)

➡️ Next guide: [10 - Hands On Lab 4.2 - Logging](../10-hol-4.2-logging/README.md)